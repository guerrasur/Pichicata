...

{
  ...
  opciones: [
    ...
    { label: "Mirarlo a los ojos y decirle que sabés que es un chanta.", requiere: { stats: { conciencia: { min: 25 } } }, requisitoTexto: "Conciencia 25",
      pericia: "conciencia", efectos: { conciencia: 12, karma: -6 }, flags: { set: ["guru_te_respeta"] },
...

{
  ...
  opciones: [
    ...
    { label: "Pedirle «lo que haya» y confiar.", pericia: "karma", efectos: { mangos: -200, paranoia: 10 }, daReliquia: true,
    ...
    { label: "Venderle algo tuyo.", pericia: "karma", efectos: { mangos: 150, conciencia: -5 },
    ...
    { label: "Pedir fiado.", requiere: { stats: { karma: { min: 20 } } }, requisitoTexto: "Karma 20",
      pericia: "karma", efectos: { paranoia: 6 }, flags: { set: ["deuda_kiosco"] },
...

{
  ...
  opciones: [
    ...
    { label: "Hacer una pregunta que lo deje en offside.", pericia: "karma", efectos: { conciencia: 15, karma: 5 }, flags: { set: ["enemigo_de_coach"] },
...

{
  ...
  opciones: [
    ...
    { label: "Seguir caminando sin frenar.", pericia: "conciencia", efectos: { paranoia: 6, karma: -3 },
...

{
  ...
  opciones: [
    ...
    { label: "Regatear todo el puesto hasta dejarlo en nada.", pericia: "karma", efectos: { mangos: -80, karma: -8, conciencia: 3 },
    ...
    { label: "Preguntarle en serio si cree en lo que vende.", pericia: "karma", efectos: { conciencia: 12, karma: 4 },
...

{
  ...
  opciones: [
    ...
    { label: "Pedir para llevar y no compartir.", pericia: "karma", efectos: { aguante: 25, karma: -12, mangos: 0 },
...

{
  ...
  opciones: [
    { label: "Coimearlo para que no diga nada.", pericia: "karma", efectos: { mangos: -200, karma: -8, paranoia: -10 },
    ...
    { label: "Invitarlo a subir.", pericia: "karma", efectos: { karma: 10, conciencia: 8, paranoia: -6 }, flags: { set: ["encargado_amigo"] },
...

{
  ...
  opciones: [
    ...
    { label: "Meditar en vez de dormir.", pericia: "conciencia", efectos: { conciencia: 10, aguante: 8, paranoia: -8 }, medita: true,
...

{
  ...
  opciones: [
    ...
    { label: "Pedirle que te lleve a otra parte.", pericia: "karma", efectos: { mangos: -250, conciencia: 5, paranoia: -8 }, flags: { set: ["desvio"] },
...

{
  ...
  opciones: [
    ...
    { label: "Escuchar sin tomar.", pericia: "conciencia", efectos: { conciencia: 14, karma: 15, aguante: -3 },
    ...
    { label: "Contar tu propia miseria y ganarle.", pericia: "conciencia", efectos: { conciencia: 5, karma: -6, efecto: 12 },
    ...
    { label: "Ofrecerle plata.", requiere: { stats: { mangos: { min: 200 } } }, requisitoTexto: "$200",
      pericia: "karma", efectos: { mangos: -200, karma: 5, conciencia: -4 },
...

{
  ...
  opciones: [
    { label: "Respirar. Contar hasta diez. Contar otra vez.", pericia: "conciencia", efectos: { paranoia: -20, conciencia: 8, aguante: -3 },
...

{
  ...
  opciones: [
    ...
    { label: "Fingir que tomás.", pericia: "karma", efectos: { karma: -8, paranoia: 15, conciencia: 2 }, flags: { set: ["mintio_en_ceremonia"] },
...

{
  ...
  opciones: [
    { label: "Entregarte.", pericia: "conciencia", efectos: { aguante: -15, conciencia: 20, efecto: -25, karma: 10 },
    ...
    { label: "Aguantarla por vergüenza.", pericia: "aguante", efectos: { aguante: -25, conciencia: 2, paranoia: 15, efecto: -5 },
    ...
    { label: "Pedirle a {personaje.nombre} que se quede.", pericia: "karma", efectos: { aguante: -10, conciencia: 12, karma: 12, paranoia: -12, efecto: -20 },
...

{
  ...
  opciones: [
    { label: "Entregarte a la música e ignorar lo que dice entre temas.", pericia: "conciencia", efectos: { conciencia: 14, paranoia: -10, efecto: 5 },
    ...
    { label: "Discutirle la teoría del flúor.", pericia: "karma", efectos: { conciencia: 6, karma: -5, paranoia: 10 }, flags: { set: ["discutio_en_ronda"] },
    ...
    { label: "Pedirle que cante una sola canción, la que ella quiera, sin hablar.", pericia: "karma", efectos: { conciencia: 18, karma: 10 },
...

{
  ...
  opciones: [
    { label: "Filmarlo y escrachar el retiro.", pericia: "karma", efectos: { karma: -15, conciencia: 25, paranoia: 12 }, flags: { set: ["retiro_quemado"] },
    ...
    { label: "Convencerte de que es una prueba del maestro.", pericia: "karma", efectos: { conciencia: -10, paranoia: 20, karma: 3 },
...

{
  ...
  opciones: [
    { label: "Aguantar y dejarte trabajar.", pericia: "aguante", efectos: { aguante: 22, conciencia: 8, paranoia: 10 },
    ...
    { label: "Preguntarle en serio por su trabajo anterior.", pericia: "karma", efectos: { conciencia: 15, paranoia: 15, karma: 3 },
...

{
  ...
  opciones: [
    ...
    { label: "Robarle el aro de luz.", pericia: "karma", efectos: { karma: -18, mangos: 250, paranoia: 20 }, flags: { set: ["ladron_de_luz"] },
...

{
  ...
  opciones: [
    ...
    { label: "Ofrecerte a ayudar.", pericia: "karma", efectos: { aguante: 8, karma: 18, conciencia: 10 },
    ...
    { label: "Chorearle comida para después.", pericia: "karma", efectos: { aguante: 12, karma: -10 },
...

{
  ...
  opciones: [
    { label: "Decirle que sí, que se puede.", pericia: "karma", efectos: { karma: 8, conciencia: 5, paranoia: 5 },
    ...
    { label: "Decirle que no sabés.", pericia: "karma", efectos: { conciencia: 15, karma: 12 },
    ...
    { label: "Ofrecerte a canalizarlo vos.", requiere: { stats: { efecto: { min: 40 } } }, requisitoTexto: "Efecto 40",
      pericia: "karma", efectos: { karma: -20, conciencia: -5, mangos: 500, paranoia: 15 }, flags: { set: ["falso_medium"] },
...

{
  ...
  opciones: [
    ...
    { label: "Invitarlo a sentarse en la ronda.", pericia: "karma", efectos: { karma: 15, conciencia: 18 },
    ...
    { label: "Pedirle que te lleve.", requiere: { stats: { paranoia: { min: 50 } } }, requisitoTexto: "Paranoia 50",
      pericia: "karma", efectos: { paranoia: -25, conciencia: 8, aguante: -5, karma: -5 }, flags: { set: ["se_fue_temprano"] },
...

{
  ...
  opciones: [
    { label: "Mirar alrededor.", pericia: "conciencia", efectos: { paranoia: 25, conciencia: 15 }, flags: { set: ["invoco_algo"] },
    ...
    { label: "No mirar. Nunca.", pericia: "conciencia", efectos: { conciencia: 10, paranoia: 8 }, flags: { set: ["no_miro"] },
    ...
    { label: "Seguir repitiéndolo mal, a propósito.", pericia: "conciencia", efectos: { karma: -20, conciencia: 30, paranoia: 20, efecto: 10 },
    ...
    { label: "Pedirle que te enseñe a decirlo bien.", pericia: "karma", efectos: { conciencia: 12, karma: 8, aguante: -5 },
...

{
  ...
  opciones: [
    ...
    { label: "Decirle que se está inventando todo.", pericia: "karma", efectos: { conciencia: 10, karma: -8, paranoia: 8 },
...

{
  ...
  opciones: [
    ...
    { label: "Ofrecerle un porro.", requiere: { flags: { any: ["tiene_faso"] } }, requisitoTexto: "tener faso",
      pericia: "karma", efectos: { efecto: 20, conciencia: 6, paranoia: 8 }, flags: { set: ["ego_pendiente"] },
...

{
  ...
  opciones: [
    { label: "Seguir.", pericia: "conciencia", efectos: { efecto: 30, aguante: -20, conciencia: 5, paranoia: 15 },
...

{
  ...
  opciones: [
    ...
    { label: "Pedirle que te hable de cualquier cosa.", pericia: "karma", efectos: { aguante: 15, conciencia: 18, karma: 12, paranoia: -20 },
...

{
  ...
  opciones: [
    ...
    { label: "Contarle lo que te está pasando.", pericia: "karma", efectos: { conciencia: 14, karma: 10, paranoia: -15 },
    ...
    { label: "Ofrecerle de lo que tenés.", requiere: { flags: { any: ["tiene_faso"] } }, requisitoTexto: "tener faso",
      pericia: "karma", efectos: { efecto: 15, karma: 12, conciencia: 15, aguante: -5 },
...

{
  ...
  opciones: [
    { label: "Mirar los números.", pericia: "conciencia", efectos: { conciencia: 15, karma: -5, paranoia: 12 },
    ...
    { label: "Decirle que se relaje, que no todo es plata.", pericia: "karma", efectos: { conciencia: 6, karma: 5, paranoia: -5 },
    ...
    { label: "Proponerle montar uno propio.", pericia: "karma", efectos: { karma: -20, mangos: 700, conciencia: 10 }, flags: { set: ["socio_del_contador"] },
...

{
  ...
  opciones: [
    ...
    { label: "Lavar la ropa que tenés puesta.", pericia: "aguante", efectos: { aguante: 8, conciencia: 10, mangos: -100, karma: 3 },
...

{
  ...
  opciones: [
    ...
    { label: "Meditar pidiendo algo concreto.", pericia: "conciencia", efectos: { conciencia: 8, karma: -5, paranoia: 5 },
